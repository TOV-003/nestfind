            ...
            <main className="my-12 md:w-3/4 flex flex-col items-center mx-auto gap-8">
                <div className="flex lg:flex-row flex-col items-center lg:justify-center gap-4 mx-4 lg:mx-0 w-full">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full border border-gray-300 bg-white p-6 rounded-lg">
                        ...
                        <div className="flex flex-col gap-1">
                            <label htmlFor='avatar' className="text-sm font-medium text-gray-700">Avatar Image URL</label>
                            <input
                                id='avatar'
                                name='avatar'
                                type="text"
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <select
                                ...
                                value={formData.role}
                                onChange={handleChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm bg-white"
                            >
